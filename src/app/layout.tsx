    ...
    <html lang="pt-BR">
      ...
      >
        <main className="grid min-h-screen grid-cols-2">
          {/* Left section */}
          <div className="relative flex max-h-screen flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover px-28 py-16">
            {/* Blur */}
